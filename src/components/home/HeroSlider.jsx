...
const slides = [
  {
    ...
    badge: "Distinct Mark Group — Riyadh, Saudi Arabia",
  ...
  },
  {
    ...
    accent: "#E8832A",
    stats: [
      { value: "Full", label: "MEP Contracting" },
      { value: "HVAC", label: "Specialists" },
  ...
  },
  {
    ...
    description: "Cutting-edge IT solutions including network installation, CCTV & security systems, software & hardware supply, and system integration.",
    image: heroImages.it,
    accent: "#0EA5E9",
    stats: [
      { value: "CCTV", label: "Security Systems" },
  ...
  },
  {
    ...
    badge: "Camp Catering • Industrial Dining • Food Supply",
    description: "Premium catering and hospitality management for industrial sites, camps, restaurants, and food supply operations.",
    image: heroImages.catering,
    accent: "#16A34A",
    stats: [
      { value: "24/7", label: "Service" },
      { value: "HACCP", label: "Certified" },
      { value: "Camp", label: "Specialists" },
    ],
    cta: "/services",
    ctaLabel: "Learn More",
  },
  {
    ...
    highlight: "Logistics",
    badge: "Staff Transport • Equipment Hauling • Logistics",
